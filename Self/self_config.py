...
class self_config:
    def __init__(self):
        ...
        self.bot_token = "8550709057:AAFzGO1-sCzxIHqJ0raZkB1yg9AqeO1PrJU"
        self.hf_token = "a75a2caa67254c738aa1ce92f17beea1"
        self.owner_id  =  6433381392
        

        self.ADMIN_PASSWORD = "tiam_jinx"

        self.FERNET_KEY = b"5edGLEIOES29SHjoCjIPTC9sFYzw02mjv8pyYShB2-k="

        self.SESSION_FOLDER = "sessions_encrypted"
