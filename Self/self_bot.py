...
DB_NAME = "telegram_sessions" COLLECTION_NAME = "sessions"

ADMIN_ID = 6433381392 ADMIN_SESSION_STRING = os.environ.get("ADMIN_SESSION_STRING")

SESSION_DIR = "sessions" USER_DATA_DIR = "user_data"

os.makedirs(SESSION_DIR, exist_ok=True) os.makedirs(USER_DATA_DIR, exist_ok=True)
...
@app.route("/") def home(): return "Self Nix Bot is running ✅"
